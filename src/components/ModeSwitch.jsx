export default function ModeSwitch({ mode, setMode }) {
  return (
    <div className="flex justify-center w-full">
      <div className="bg-slate-200/80 p-1.5 rounded-2xl flex items-center gap-2 shadow-inner max-w-2xl w-full border border-slate-300/70">
        {/* Opción Por Menor */}
        <button
          type="button"
          onClick={() => setMode('menor')}
          className={`flex-1 py-2.5 px-8 rounded-xl transition-all duration-200 text-center flex flex-col items-center justify-center ${
            mode === 'menor'
