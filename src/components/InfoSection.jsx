  ...
  return (
    <section id="informacion" className="mt-20 pt-12 border-t border-slate-200">
      <div className="text-center max-w-xl mx-auto mb-10">
        <span className="text-xs font-bold text-sky-800 tracking-wider uppercase bg-sky-100 px-3 py-1 rounded-full border border-sky-200">
          Guía de compra
        </span>
